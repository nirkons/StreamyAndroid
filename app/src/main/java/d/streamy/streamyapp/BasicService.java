...
public class BasicService extends Service {
    ...
    //get position of nth string within a string
...
//allow VLC to connect to the VLC API with basic auth
...
//check if device is emitting audio
    ...
    private class SendtoSpotify extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Log.d("just checking","delay");

            return null;
        }

        private class spottask extends TimerTask {
